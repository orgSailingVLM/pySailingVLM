...
class SailFactory:
    ...
    def make_main_sail(self, main_sail_luff, boom_above_sheer, main_sail_chords=None, sail_twist_deg=None, LLT_twist=None, interpolated_camber=None, interpolated_distance_from_LE=None):
