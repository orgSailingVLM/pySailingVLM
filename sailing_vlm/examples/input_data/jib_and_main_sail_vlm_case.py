...
alpha_true_wind_deg =20+10+ 50.   # [deg] true wind angle (with reference to course over ground) => Course Wind Angle to the boat track = true wind angle to centerline + Leeway
...
main_sail_centerline_twist_deg = 10 + 0* 12. * main_sail_girths
...
jib_sail_camber= 0.25*np.array([0.09, 0.09, 0.09, 0.09, 0.09])
...
main_sail_camber=0.25* np.array([0.09, 0.09, 0.09, 0.09, 0.09, 0.09, 0.09])
